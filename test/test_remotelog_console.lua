...
function test_console_log:assert_message(message)
    luaunit.assertEquals(message, last_message)
end

function test_console_log:assert_no_message()
...
function test_console_log:test_set_level_to_illegal_value_throws_error()
...
function test_console_log:test_unsetting_print_does_not_break_fallback()
    _G.print = nil
